...
public class AdminService : IAdminService
{
    ...
    public async Task RefundPaymentAsync(int paymentId, RefundDto? dto)
    {
        ...
        // Ghi log WalletTransaction cho hoàn tiền admin
        await _walletTransactionService.LogTransactionAsync(
            payment.Order.UserId, payment.Amount, balanceBefore, user.Wallet,
            "Refund", dto?.Note ?? "Admin hoàn tiền", payment.OrderId);
    }
