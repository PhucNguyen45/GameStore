    ...
    >
      ...
      >
        ...
        >
          ...
          >
            <div>
              <span style={{ color: "#666" }}>Người dùng:</span>{" "}
          ...
          payments.map((p) => (
            ...
            >
              ...
              <div style={{ color: "#666", fontSize: 10, marginTop: 4 }}>
                {formatVND(p.amount || 0)} • {new Date(p.paidAt).toLocaleString()}
...
export default function PaymentsTab() {
  ...
  const handleRefund = async (p) => {
    const note = prompt("Ghi chú hoàn tiền (tùy chọn):", "Hoàn tiền từ admin");
    if (note === null) return;
    try {
  ...
  return (
    <div>
      ...
      >
        <input
          placeholder="Tìm ID, TXN hoặc tên..."
        ...
        >
          <thead>
            <tr style={{ background: "#0a0a10" }}>
              ...
              <th style={{ ...thStyle, cursor: "default" }}>Thao tác</th>
            </tr>
          </thead>
          <tbody>
            {payments.map((p) => (
