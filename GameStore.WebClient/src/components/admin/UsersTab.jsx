    ...
    <div>
      ...
      >
        <input
          ...
          onChange={(e) =>
            setUserSearch({ ...userSearch, keyword: e.target.value })
          }
        ...
        <select
          ...
          onChange={(e) =>
            setUserSearch({ ...userSearch, status: e.target.value })
          }
        ...
        >
          ...
          <input
            ...
            onChange={(e) =>
              setUserSearch({ ...userSearch, fromDate: e.target.value })
            }
            style={filterInputStyle}
          />
        </div>
        ...
        >
          ...
          <input
            ...
            onChange={(e) =>
              setUserSearch({ ...userSearch, toDate: e.target.value })
            }
            style={filterInputStyle}
          />
        </div>
