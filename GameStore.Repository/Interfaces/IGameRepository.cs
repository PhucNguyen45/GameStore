...
{
    Task<(List<Game> Games, int TotalCount)> SearchAsync(string? keyword, int[]? genreIds, long? minPrice, long? maxPrice, string? sortBy, bool descending, int page, int pageSize);
