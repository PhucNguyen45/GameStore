...
namespace GameStore.Repository.Migrations
{
    ...
    [Migration("20260618140024_AddGameKeyGameIdCheckConstraint")]
    partial class AddGameKeyGameIdCheckConstraint
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("GameStore.Entities.Users.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            IsActive = true,
                            Password = "1MeRp4SWtQb1IW74olJ/rPNmUiEQuVguuMm+dnyFt+k=",
                            Phone = "",
                            Salt = new byte[] { 88, 16, 130, 143, 5, 66, 32, 15, 139, 66, 166, 13, 102, 220, 206, 192 },
                            Username = "admin",
                            Wallet = 9999000L
                        });
                });
