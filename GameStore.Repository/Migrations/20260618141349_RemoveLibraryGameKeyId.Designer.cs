...
namespace GameStore.Repository.Migrations
{
    ...
    [Migration("20260618141349_RemoveLibraryGameKeyId")]
    partial class RemoveLibraryGameKeyId
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("GameStore.Entities.Users.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            IsActive = true,
                            Password = "bTUc1Xm/J6NK9MeRVWfDYVpssz5GU7Whi3xBxR4NzA0=",
                            Phone = "",
                            Salt = new byte[] { 133, 42, 30, 113, 66, 145, 56, 81, 146, 8, 36, 65, 164, 88, 43, 243 },
                            Username = "admin",
                            Wallet = 9999000L
                        });
                });
