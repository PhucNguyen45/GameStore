...
namespace GameStore.Repository.Migrations
{
    ...
    [Migration("20260618184126_AddRecipientEmailToOrder")]
    partial class AddRecipientEmailToOrder
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("GameStore.Entities.Users.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            IsActive = true,
                            Password = "Y83b1Z3U/1NGqsGYHIP8S7q9QqkpgzZVLqClJt3t368=",
                            Phone = "",
                            Salt = new byte[] { 158, 216, 60, 175, 59, 4, 63, 75, 220, 240, 81, 104, 148, 182, 13, 158 },
                            Username = "admin",
                            Wallet = 9999000L
                        });
                });
